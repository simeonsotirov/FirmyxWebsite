/**
 * Logo component â€” uses CSS (dark:hidden / dark:block) to switch between
 * light and dark mode logos instantly, with zero JavaScript and no flash.
 *
 * Place your logo files in /public/:
 *   /public/logo-light.png  â† shown on light backgrounds
 *   /public/logo-dark.png   â† shown on dark backgrounds
 *
...
export default function Logo({ size = 'md', className = '' }: LogoProps) {
  ...
  return (
    <span className={`inline-flex items-center select-none ${className}`}>
      {/* Light mode logo â€” hidden in dark mode */}
      <Image
        src="/logo-light.png"
        alt="Firmyx"
        width={160}
      ...
      />
      {/* Dark mode logo â€” hidden in light mode */}
      <Image
        src="/logo-dark.png"
        alt="Firmyx"
        width={160}
